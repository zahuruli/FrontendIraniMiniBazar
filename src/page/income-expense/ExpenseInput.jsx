...
try {
  const res = await axios.post(`https://backendofsupershoppos.onrender.com/api/transactionsRouter/postComPaidAmountTransactionFromAnyPage?amount=${total}&paid=${paid}&comment=${expenseName}&date${currentDate}`)
