 ...
 const Employee = localStorage.getItem("username")
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/paymenttypes/getAll"
        );
    ...
    const fetchDataUnit = async () => {
      try {
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/unit/getAll"
        );
    ...
    const fetchSupplierData = async () => {
      try {
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/contributorname/getAll"
        );
    ...
    const fetchBrandData = async () => {
      try {
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/brand/getAll"
        );
    ...
    const fetchShop = async () => {
      try {
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/shopname/getAll"
        );
    ...
    const fetchVatData = async () => {
      try {
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/tax/getAll"
        );
