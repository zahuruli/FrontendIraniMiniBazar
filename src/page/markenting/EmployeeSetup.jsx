    ...
    try {
      ...
      if (employeeCachedData) {
        ...
        const response = await axios.get(
          "https://backendofsupershoppos.onrender.com/api/employee/getAll"
        );
    ...
    try {
      if (
        ...
        const res = await axios.post(
          "https://backendofsupershoppos.onrender.com/api/employee/postEmployeeFromAnyPage",
          {
            mobile,
            address,
            nid,
    ...
    try {
      if (!update_employee_id) {
        ...
        const res = await axios.put(
          "https://backendofsupershoppos.onrender.com/api/employee/updateEmployeeFromAnyPage",
          {
  ...
  const deleteEmployee = async () => {
    try {
      ...
      const res = await axios.delete(
        `https://backendofsupershoppos.onrender.com/api/employee/deleteEmployeeFromAnyPage`,
